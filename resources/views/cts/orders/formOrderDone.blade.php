                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="custom-img" >
                                        <img  id="img" src="{{$product['image']}}"  alt="image">
                                        <span style="margin:0"> {{$product['name']}}</span>
                                    </div>
                                    @endforeach
                                </td>
                                ...
                                <td>
                                    @if ($item['status'] == 1)
                                    <a href="{{route('order.setStatusOrder',$item['id'])}}" class="btn btn-danger btn-sm">chưa giao</a>
                                    @else
                                    <a href="{{route('order.setStatusOrder',$item['id'])}}" class="btn btn-success btn-sm">giao thành công</a>
                                    @endif
                                </td>
                                <td>
